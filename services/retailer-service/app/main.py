"""Retailer service FastAPI entrypoint."""
...
from app.api.routes import retailer_router
...
def create_app() -> FastAPI:
    app = FastAPI(
        title="FACCP Retailer Service",
        version=settings.service_version,
        description="Retailer Organizations, Store Network, Excise Licenses, Operating Hours, Staff Management",
        lifespan=lifespan,
    )
    app.add_middleware(
        CORSMiddleware,
