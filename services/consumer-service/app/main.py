"""Consumer service FastAPI entrypoint."""
...
from app.api.routes import consumer_router
...
def create_app() -> FastAPI:
    app = FastAPI(
        title="FACCP Consumer Service",
        version=settings.service_version,
        description="Profiles, Address Book, Age Verification Records, Consumer Tier Vault",
        lifespan=lifespan,
    )
    app.add_middleware(
        CORSMiddleware,
