"""Compliance service FastAPI entrypoint."""
...
from app.api.routes import compliance_router
...
def create_app() -> FastAPI:
    app = FastAPI(
        title="FACCP Compliance Service",
        version=settings.service_version,
        description="Policy Engine, Jurisdiction Rules, Dry-Day Calendar, Regulatory Checks",
        lifespan=lifespan,
    )
    app.add_middleware(
        CORSMiddleware,
