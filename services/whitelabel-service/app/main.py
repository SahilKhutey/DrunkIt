...
async def lifespan(app: FastAPI) -> Any:
    ...
    if settings.enable_tracing and setup_telemetry is not None:
        setup_telemetry(
...
def create_app() -> FastAPI:
    app = FastAPI(
        title="FACCP White-Label Service",
    ...
    if settings.enable_tracing and instrument_fastapi is not None:
