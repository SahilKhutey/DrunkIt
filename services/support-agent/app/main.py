"""Support agent service FastAPI entrypoint."""
...
from app.api.routes import support_router
...
def create_app() -> FastAPI:
    app = FastAPI(
        title="FACCP AI Support Agent Service",
        version=settings.service_version,
        description="Automated Customer Support, RAG Knowledge Base & Regulatory Guidance",
        lifespan=lifespan,
    )
    app.add_middleware(
        CORSMiddleware,
